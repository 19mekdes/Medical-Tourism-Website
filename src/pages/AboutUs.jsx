      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-16 lg:mb-24">
          ...
          <p className="mt-6 text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto">
            15+ years helping patients from <span className="text-[#EC4E00] font-bold">80+ countries</span> get world-class treatment + luxury recovery
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">

          {/* LEFT: Image with beautiful hover */}
          ...
          <div className="space-y-10">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              From your first message until you’re back home healthy, your personal coordinator is with you 24/7 — handling visas, flights, luxury hotels, translation, insurance, and daily check-ins.
            </p>

            {/* Stats */}
            <div className="grid grid-cols-2 gap-8">
              <div className="text-center">
                <div className="text-5xl font-black text-[#2256CF]">50,000+</div>
                <div className="text-lg font-semibold text-gray-600 mt-2">Happy Patients</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-black text-[#EC4E00]">15+</div>
                <div className="text-lg font-semibold text-gray-600 mt-2">Partner Countries</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-black text-[#2256CF]">24/7</div>
                <div className="text-lg font-semibold text-gray-600 mt-2">Personal Support</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-black text-[#EC4E00]">100%</div>
                <div className="text-lg font-semibold text-gray-600 mt-2">Transparent Pricing</div>
              </div>
            </div>
